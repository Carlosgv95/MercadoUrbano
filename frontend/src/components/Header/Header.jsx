...
const slide2 = "https://img.freepik.com/vector-gratis/promocion-ventas-abstractas_23-2148338919.jpg?semt=ais_hybrid&w=1200&q=80";
    ...
    <Carousel fade interval={4000} className="custom-carousel">
      ...
      <Carousel.Item>
        ...
        <img
          ...
          src={slide1}
          alt="Logo MercadoUrbano"
        />
        <Carousel.Caption className="carousel-caption">
          <h2 className="carousel-title">Bienvenido a MercadoUrbano</h2>
      ...
      <Carousel.Item>
        ...
        <img
          className="d-block w-100 carousel-image"
          src={slide3}
          alt="Tecnología y más"
        />
        <Carousel.Caption className="carousel-caption">
          <h2 className="carousel-title">Tecnología, Hogar y Más</h2>
